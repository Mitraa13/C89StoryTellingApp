        ...
        <View style={this.state.light_theme?styles.containerLight: styles.container}>
          ...
          <View style={styles.screenContainer}>
            ...
            <View style={styles.themeContainer}>
              <Text style={this.state.light_theme?styles.themeTextLight:styles.themeText}>{this.state.light_theme? "Light Theme": "Dark Theme"}</Text>
            </View>
            ...
            <View style={styles.switchContainer}>
              <Switch
                ...
                trackColor={{ false: "#767577", true: this.state.light_theme? "#eee": "#fff" }}
